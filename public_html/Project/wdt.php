...
while ($row = $display->fetch()){
    ...
    <option id = '.$row["account_type"].' value = '.$row["account_number"].'> '.$row["account_type"].' </option> 
    ';
}
...
<br> <label for="amount-deposit">How much money would you like to deposit? </label> <input type="textbox" id="deposit_box" name="deposit_box"> <br>
<br><br>
...
<br><label for="amount-withdraw">How much money would you like to withdraw? </label> <input type="textbox" id="withdraw_box" name="withdraw_box"> <br>
<br><br>
...
<br> <label for="amount-xfer-from">How much money would you like to transfer? </label> <input type="textbox" id="xfer_to_box" name="xfer_to_box"> <br>
